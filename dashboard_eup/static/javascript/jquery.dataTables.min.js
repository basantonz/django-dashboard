...
(function(l) { "function" === typeof define && define.amd ? define(["jquery"], function(z) { return l(z, window, document) }) : "object" === typeof exports ? module.exports = function(z, A) { z || (z = window);
    ...
    function Ga(a, b, c) {
        ...
        if (!b.sWidthOrig) { b.sWidthOrig = e.attr("width") || null; var h = (e.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/);
            h && (b.sWidthOrig = h[1]) } c !== q && null !== c && (zb(c), P(u.defaults.column, c, !0), c.mDataProp === q || c.mData || (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), l.extend(b, c), X(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== q && (b.aDataSort = [c.iDataSort]), X(b, c, "aDataSort"));
        var g = b.mData,
            f = na(g),
    ...
    function ta(a) { if (!1 !== a.oFeatures.bAutoWidth) { var b = a.aoColumns;
            Ya(a); for (var c = 0, d = b.length; c < d; c++) b[c].nTh.style.width = b[c].sWidth } b = a.oScroll; "" === b.sY && "" === b.sX || Ha(a);
    ...
    function Za(a) {
        ...
        for (e = b.length; f < e; f++) {
            ...
            if (!k.sType && k._sManualType) k.sType = k._sManualType;
                ...
                var m =
                    0;
                for (h = d.length; m < h; m++) { var p = 0; for (g = c.length; p < g; p++) { n[p] === q && (n[p] = T(a, p, f, "type")); var t = d[m](n[p], a); if (!t && m !== d.length - 1) break; if ("html" === t && !Z(n[p])) break } if (t) { k.sType = t; break } } k.sType || (k.sType = "string")
            }
        }
    }
        ...
        if (b) {
            ...
            for (d = h.length; k < d; k++) {
                ...
                for (b = h[k].length; e < b; e++) { var n = f = 1; if (g[k][e] === q) { a.appendChild(h[k][e].cell); for (g[k][e] = 1; h[k + f] !== q && h[k][e].cell == h[k + f][e].cell;) g[k + f][e] = 1, f++; for (; h[k][e + n] !== q && h[k][e].cell == h[k][e + n].cell;) { for (c = 0; c < f; c++) g[k + c][e + n] = 1;
                            n++ } l(h[k][e].cell).attr("rowspan", f).attr("colspan", n) } }
            }
        }
    }
        ...
        for (var h = a.sDom.split(""), g, f, k, n, m, p, t = 0; t < h.length; t++) {
            ...
            if ("<" == f) { k = l("<div/>")[0];
                ...
                for (k = u.ext.feature, p = 0, n = k.length; p < n; p++)
                    if (f == k[p].cFeature) { g = k[p].fnInit(a); break } g && (k = a.aanFeatures, k[f] || (k[f] = []), k[f].push(g), e.append(g))
        }
        c.replaceWith(e);
        a.nHolding = null
    }
        ...
        for (e =
            b.length; h < e; h++) { var g = b[h]; for (c = g.firstChild; c;) { if ("TD" == c.nodeName.toUpperCase() || "TH" == c.nodeName.toUpperCase()) { var f = 1 * c.getAttribute("colspan"); var k = 1 * c.getAttribute("rowspan");
                    ...
                    k = k && 0 !== k && 1 !== k ? k : 1; var n = 0; for (d = a[h]; d[n];) n++; var m = n; var p = 1 === f ? !0 : !1; for (d = 0; d < f; d++)
                        for (n = 0; n < k; n++) a[h + n][m + d] = { cell: c, unique: p }, a[h + n].nTr = g } c = c.nextSibling } }
    }
    ...
    function Oa(a, b, c) {
        ...
        if (l.isPlainObject(h) && h.data) { var k = h.data; var n = "function" === typeof k ? k(b, a) : k;
            ...
            delete h.data } n = { data: b, success: f, dataType: "json", cache: !1, type: a.sServerMethod, error: function(m, p, t) { t = F(a, null, "xhr", [a, null, a.jqXHR]); - 1 === l.inArray(!0, t) && ("parsererror" == p ? da(a, 0, "Invalid JSON response", 1) : 4 === m.readyState && da(a, 0, "Ajax error", 7));
                V(a, !1) } };
        a.oAjaxData = b;
        F(a, null, "preXhr", [a, b]);
    ...
    function Ba(a) {
        ...
        if (a.bInitialised) { Hb(a);
            ...
            d.bAutoWidth && Ya(a); var h = 0; for (d = c.length; h < d; h++) { var g = c[h];
                g.sWidth && (g.nTh.style.width = K(g.sWidth)) } F(a, null, "preInit", [a]);
            ka(a);
    ...
    function Ra(a) { var b = a.aLastSort,
            ...
            h; if (e.bSort && e.bSortClasses) { e = 0; for (h = b.length; e < h; e++) { var g = b[e].src;
                l(U(a.aoData, "anCells", g)).removeClass(c + (2 > e ? e + 1 : 3)) } e = 0; for (h = d.length; e < h; e++) g = d[e].src, l(U(a.aoData, "anCells", g)).addClass(c + (2 > e ? e + 1 : 3)) } a.aLastSort = d }
    ...
    function pb(a, b, c) { var d; for (d in b)
            if (b.hasOwnProperty(d)) { var e = b[d];
                l.isPlainObject(e) ? (l.isPlainObject(a[d]) || (a[d] = {}), l.extend(!0, a[d], e)) : c && "data" !== d && "aaData" !== d && Array.isArray(e) ? a[d] = e.slice() : a[d] = e } return a }
                ...
                if ("table" != this.nodeName.toLowerCase()) da(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    g = function() {
                        if (f.aaSorting === q) { var I = r.aaSorting;
                            k = 0; for (n = I.length; k < n; k++) I[k][1] = r.aoColumns[k].asSorting[0] } Ra(r);
            ...
            var b = function(c, d, e) {
                ...
                for (var g, f, k = 0, n = e.length - 1; k < n; k++) { if ("__proto__" === e[k] || "constructor" === e[k]) throw Error("Cannot set prototype values");
                    ...
                    f = e[k].match(sa); if (g) { e[k] = e[k].replace(Fa, "");
                        ...
                        else c[e[k]] = d; return } f && (e[k] = e[k].replace(sa, ""), c = c[e[k]](d)); if (null === c[e[k]] || c[e[k]] === q) c[e[k]] = {};
                    c = c[e[k]] }
        ...
        if (Array.isArray(a))
            ...
            for (c = d.length; a < c; a++) {
                ...
                a: { var f = 0; for (var k = e.length; f < k; f++)
                        if (e[f].name === g) { f = e[f]; break a } f = null } f || (f = { name: g, val: {}, methodExt: [], propExt: [], type: "object" }, e.push(f));
    ...
    var tb = function(a, b, c, d, e) { var h = [],
            ...
            n = 0; for (f = b.length; n < f; n++) { var m = b[n] && b[n].split && !b[n].match(/[\[\(:]/) ? b[n].split(",") : [b[n]]; var p = 0; for (k = m.length; p < k; p++)(g = c("string" === typeof m[p] ? m[p].trim() : m[p])) && g.length && (h = h.concat(g)) } a = M.selector[a]; if (a.length)
        ...
        this.iterator("row", function(b, c, d) { var e = b.aoData,
            ...
            e.splice(c, 1); var k = 0; for (g = e.length; k < g; k++) { var n = e[k]; var m = n.anCells;
                null !== n.nTr && (n.nTr._DT_RowIndex = k); if (null !== m)
                    for (n = 0, f = m.length; n < f; n++) m[n]._DT_CellIndex.row = k } La(b.aiDisplayMaster, c);
            La(b.aiDisplay, c);
            La(a[d], c, !1);
    ...
    l.extend(!0, u.ext.renderer, {
        pageButton: {
            _: function(a, b, c, d, e, h) {
                ...
                try { var v = l(b).find(A.activeElement).data("dt-idx") } catch (x) {} t(l(b).empty(), d);
